...
try:
    ...
    HAS_CUPY = True
    print("[Quantum] OK: CUDA GPU acceleration available")
except ImportError:
    HAS_CUPY = False
    print("[Quantum] NO: CUDA not available (install cupy for GPU acceleration)")

try:
    import pyopencl as cl  # OpenCL for AMD/Intel GPUs
    HAS_OPENCL = True
    print("[Quantum] OK: OpenCL GPU acceleration available")
except ImportError:
    HAS_OPENCL = False
...
try:
    ...
    HAS_TORCH = True
    print("[Quantum] OK: PyTorch for neural duplicate detection")
except ImportError:
    HAS_TORCH = False
...
try:
    ...
    HAS_ZMQ = True
    print("[Quantum] OK: ZeroMQ for distributed scanning")
except ImportError:
    HAS_ZMQ = False
...
try:
    ...
    HAS_UVLOOP = True
    print("[Quantum] OK: uvloop for async I/O (2-4x faster)")
except ImportError:
    HAS_UVLOOP = False
