# cerebro/engine/reporting/json_report.py
"""
JSON audit report exporter (engine home).
Produces a single JSON file: scan metadata, duplicate groups summary, delete plan, policy/dry-run.
Duck-typed to avoid tight coupling.
"""
