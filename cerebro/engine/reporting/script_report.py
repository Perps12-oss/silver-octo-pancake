# cerebro/engine/reporting/script_report.py
"""
Cleanup script exporter (engine home).
Emits cleanup.sh (bash) and cleanup.ps1 (PowerShell); safe default = dry run, EXECUTE=1 to run.
"""
